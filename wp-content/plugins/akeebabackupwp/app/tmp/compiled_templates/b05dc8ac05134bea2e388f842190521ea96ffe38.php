<?php /* C:\xampp\htdocs\wordpress\wp-content\plugins\akeebabackupwp\app\Solo\ViewTemplates\Log\default.blade.php */ ?>
<?php
/**
 * @package   solo
            ...
            <div class="akeeba-form-group--actions">
                <a class="akeeba-btn--primary"
                   href="<?php echo $this->container->router->route('index.php?view=Log&task=download&format=raw&tag=' . urlencode($this->tag)); ?>">
                    ...
                    <?php echo \Awf\Text\Text::_('COM_AKEEBA_LOG_LABEL_DOWNLOAD'); ?>
                </a>
...
<?php if(!empty($this->tag)): ?>
    <?php if($this->logTooBig): ?>
        <div class="akeeba-block--warning">
            <p>
                <?php echo \Awf\Text\Text::sprintf('COM_AKEEBA_LOG_SIZE_WARNING', number_format($this->logSize / (1024 * 1024), 2)); ?>
            </p>
            <button class="akeeba-btn--dark" id="showlog">
                <?php echo \Awf\Text\Text::_('COM_AKEEBA_LOG_SHOW_LOG'); ?>
            </button>
        </div>
    <?php endif; ?>
...
<?php if( ! (isset($this->logs) && count($this->logs))): ?>
    <div class="alert alert-danger">
        <?php echo \Awf\Text\Text::_('COM_AKEEBA_LOG_NONE_FOUND'); ?>
    </div>
<?php endif; ?>
